 ...
 */
class IndexerSet : public frc2::CommandHelper<frc2::Command, IndexerSet> {
 public:
  explicit IndexerSet(double position, ShooterSubsystem* shooterRef);
 ...
 private:
    double target = 0.0;
    ShooterSubsystem *indexer;
    bool origAutoIndexState;
};